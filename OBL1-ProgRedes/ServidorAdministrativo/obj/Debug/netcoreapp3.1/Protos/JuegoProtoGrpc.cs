...
namespace ServidorAdministrativo.Protos {
  public static partial class ServicioJuego
  {
    ...
    public abstract partial class ServicioJuegoBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task<global::ServidorAdministrativo.Protos.ProtoBool> AgregarCalificacionAsync(global::ServidorAdministrativo.Protos.CalificacionProto request, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static grpc::ServerServiceDefinition BindService(ServicioJuegoBase serviceImpl)
    {
      return grpc::ServerServiceDefinition.CreateBuilder()
          ...
          .AddMethod(__Method_AgregarCalificacion, serviceImpl.AgregarCalificacionAsync)
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, ServicioJuegoBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_AgregarCalificacion, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::ServidorAdministrativo.Protos.CalificacionProto, global::ServidorAdministrativo.Protos.ProtoBool>(serviceImpl.AgregarCalificacionAsync));
